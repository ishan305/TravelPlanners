...
app.post("/", function (req, res) {
    ...
    console.log(t3);
    console.log(d3.get("Hangar")); //check line 157
    res.render("index", { restaurants: arr1, sites: arr2, bars: arr3, restaurants_timings: t1, sites_timings: t2, bars_timings: t3, restaurants_duration: d1, sites_duration: d2, bars_duration: d3}); 
});
